...
class Acta_presidencialType extends AbstractType
{
    /**
        ...
        $builder
            ...
            ->add('jrv', 
             EntityType::class, 
                                ...
                                array(
                                    'class' => \AppBundle\Entity\Jrv::class,
                                    'class' => 'AppBundle:Jrv',
                            'choice_label' => 'jrvnum',
                            'choice_value' => 'id',
                                    'placeholder'=> 'Seleccione Centro de Votacion',
                ...
                ->add('fmln', 
                 ...
                 ->add('coalicion', 
                    ...
                    array(
                       'required'   => true,
                        "attr" => array
                        ('class' => 'form-control', 'placeholder'=>'Votos COALICION ARENA')))   
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\Acta_presidencial'
        ));
    }
}
