...
// Returns the private 'security.request_matcher.0zajqpr' shared service.
...
return $this->services['security.request_matcher.0zajqpr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/auth/login');
