 ...
 */
class Transmitter extends \AppBundle\Entity\Transmitter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Transmitter' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Transmitter' . "\0" . 'fullname', '' . "\0" . 'AppBundle\\Entity\\Transmitter' . "\0" . 'phonenumber', '' . "\0" . 'AppBundle\\Entity\\Transmitter' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Transmitter' . "\0" . 'addedby'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Transmitter $proxy) {
