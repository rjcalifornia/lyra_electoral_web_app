...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\Acta_presidencialType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Acta_presidencialType']) ? $this->services['AppBundle\\Form\\Acta_presidencialType'] : ($this->services['AppBundle\\Form\\Acta_presidencialType'] = new \AppBundle\Form\Acta_presidencialType())) && false ?: '_'};
}, 'AppBundle\\Form\\DiputadoType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\DiputadoType']) ? $this->services['AppBundle\\Form\\DiputadoType'] : ($this->services['AppBundle\\Form\\DiputadoType'] = new \AppBundle\Form\DiputadoType())) && false ?: '_'};
