...
return $this->services['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['superadmin' => ['password' => 'superadminpw', 'roles' => [0 => 'ROLE_SUPER_ADMIN']]]);
