 ...
 */
class Devices extends \AppBundle\Entity\Devices implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Devices' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Devices' . "\0" . 'deviceid', '' . "\0" . 'AppBundle\\Entity\\Devices' . "\0" . 'phonenumber', '' . "\0" . 'AppBundle\\Entity\\Devices' . "\0" . 'authid'];
        }
